...
class RVOL(IndicatorBase):
    ...
    def __init__(
        self, name: str, symbol: str, timeframe: str, period: int = 20
    ) -> None:
        ...
        self.volume_history = deque(maxlen=period)
    ...
    def update(self, candle: Candle) -> None:
        ...
        try:
            ...
            average_volume = sum(self.volume_history) / self.period

            if average_volume <= 0:
                self.rvol_value = 0.0

            else:
                self.rvol_value = volume / average_volume
    ...
    def get_value(self) -> float:
        ...
        return round(self.rvol_value, 4)
