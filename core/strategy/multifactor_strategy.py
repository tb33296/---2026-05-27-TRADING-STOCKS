...
class MultiFactorStrategy:
    ...
    def evaluate(
        ...
        if (
            self.ema_fast.get_value()
            >
            self.ema_slow.get_value()
        ):

            score += (
                self.loader.get_weight(
                    "trend",
                    "ema_bullish"
                )
            )
