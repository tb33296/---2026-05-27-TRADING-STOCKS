...
```text
!! 2026-05-27 TRADING STOCKS (36 folders, 148 files)/
...
│   ├── strategy (0 folders, 5 files)/
│   │   ├── crossover_strategy.py (219 lines)
│   │   ├── multifactor_strategy.py (0 lines)
...
│   ├── test_multifactor_strategy.py (0 lines)
