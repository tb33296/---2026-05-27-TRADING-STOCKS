...
│   │   └── websocket_manager.py (408 lines)
│   ├── __init__.py (0 lines)
│   └── logging_manager.py (64 lines)
├── data (2 folders, 3 files)/
│   ├── calendar (0 folders, 1 files)/
│   │   └── holiday.txt (16 lines)
│   ├── instruments (0 folders, 1 files)/
│   │   └── OpenAPIScripMaster.json (0 lines)
│   └── market_data.db (27 lines)
